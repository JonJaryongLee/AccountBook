...
CREATE TABLE `income` (
  ...
  `num` int(11) NOT NULL,
  `Category_name` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '수입'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `income` (`ID`, `Category_Detail`, `Content`, `price`, `Date_d`, `Division`, `num`, `Category_name`) VALUES
...
('tg123', '용돈', '삼촌께 받음', 5000, '2020-05-03', '+', 5, '수입'),
('tg123', '용돈', '가게손님께 받음', 10000, '2020-05-03', '+', 6, '수입'),
...
('jr3', '투자', '부동산투자', 300000, '2020-05-15', '+', 12, '수입');
...
('jr3', '비상금', '비상금', '대출이자', '현금', '2020-05-06', 40000, '-', 49),
('tg123', '비상금', '비상금', '대출이자', '현금', '2020-05-06', 40000, '-', 50);
...
INSERT INTO `work_income` (`ID`, `Category_Detail`, `Content`, `Date_d`, `Time`, `Division`, `num`, `Category_name`) VALUES
('sj1212', '월급', 'GS25편의점', '2020-05-01', 48, '+', 1, '수입'),
('tg123', '일급', '고깃집 서빙 알바', '2020-05-01', 10, '+', 2, '수입'),
('tg123', '일급', '고깃집 서빙 알바', '2020-05-04', 8, '+', 3, '수입'),
('tg123', '일급', '고깃집 서빙 알바', '2020-05-05', 5, '+', 4, '수입'),
('tg123', '일급', '고깃집 서빙 알바', '2020-05-07', 3, '+', 5, '수입'),
('tg123', '일급', '고깃집 서빙 알바', '2020-05-10', 6, '+', 6, '수입'),
('mi111', '월급', '모다아울렛 월급', '2020-05-07', 160, '+', 7, '수입'),
('jr3', '주급', '가게 카드판매값 계좌 입금', '2020-05-06', 5, '+', 8, '수입'),
('jr3', '주급', '가게 카드판매값 계좌 입금', '2020-05-13', 5, '+', 9, '수입'),
('tg123', '일급 ', '야간알바', '2020-05-05', 5, '+', 12, '수입');
